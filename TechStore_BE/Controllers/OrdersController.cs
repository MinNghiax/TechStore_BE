...
namespace TechStore_BE.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        // GET: api/Orders?page=1&pageSize=30
        [HttpGet]
